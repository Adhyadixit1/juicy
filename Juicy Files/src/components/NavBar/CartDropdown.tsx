  ...
  return (
    <div className={wrapperClass} style={animation}>
      <div className="p-4">
        ...
        {/* Cart Items */}
        <div className={`space-y-3 ${isDesktop ? 'max-h-60' : 'max-h-[40vh]'} overflow-y-auto styled-scrollbar`}>
          {cartItems.map((item) => (
            <div
              key={item.id}
              className="flex items-center gap-3 bg-gray-50 p-2 rounded-lg"
            >
              <div className={`${isDesktop ? 'w-12 h-12' : 'w-14 h-14'} bg-gray-100 rounded-md overflow-hidden flex-shrink-0`}>
              ...
              <button className={`text-gray-400 hover:text-gray-600 ${!isDesktop && 'p-2'}`}>
                <svg
        ...
        <div className="border-t border-gray-100 mt-3 pt-3">
          ...
          <div className="space-y-2">
            <button
              className={`w-full text-white ${isDesktop
